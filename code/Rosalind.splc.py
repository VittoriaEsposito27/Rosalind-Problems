...
for s in lst:
    if s == lst[0]:
        ...
        introns.append(s)
s = lst[0]
intron0,intron1,intron2,intron3,intron4,intron5,intron6,intron7,intron8,intron9,intron10,intron11,intron12,intron13 = [str(e) for e in introns]
